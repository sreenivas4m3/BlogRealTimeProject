...
#send_mail('Hello', 'Very imp msg....','sreenivas3424m3@gmail.com',['xxx@gmail.com','yyy@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'sreenivas3424m3@gmail.com', [cd['to']]) #use[] or ()tuple
            sent=True;
    else:
	    form=EmailSendForm()
